...
public final class AdminConsoleDtos {
    ...
    public record RagTestRunRequest(
            ...
            String forcedRetrievalMode,
            Boolean agenticMultiQueryEnabled,
    ...
    public record RuntimeOptionsResponse(
            ...
            List<String> rewriteQueryProfiles,
            ...
            List<RuntimeOption> rewriteQueryProfileOptions,
