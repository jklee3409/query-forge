...
VALUES (
    ...
    'seed:configs/prompts/rewrite/selective_rewrite_v2.md:v5',
    TRUE,
    '{"seed": "V41", "reason": "synthetic_example_first_cautious_anchor_rewrite_contract"}'::jsonb,
    'file'
)
...
VALUES (
    ...
    'seed:configs/prompts/rewrite/selective_rewrite_en_v1.md:v3',
    TRUE,
    '{"seed": "V41", "reason": "synthetic_example_first_cautious_anchor_english_rewrite_contract"}'::jsonb,
    'file'
)
ON CONFLICT (prompt_family, prompt_name, version) DO UPDATE
SET content_path = EXCLUDED.content_path,
...
SELECT 'rag_rewrite.ko',
       ...
       '{"seed": "V41", "active_version": "v5"}'::jsonb
FROM active_prompt
...
SELECT 'rag_rewrite.en',
       ...
       '{"seed": "V41", "active_version": "v3"}'::jsonb
FROM active_prompt
ON CONFLICT (binding_key) DO UPDATE
SET active_prompt_asset_id = EXCLUDED.active_prompt_asset_id,
    description = EXCLUDED.description,
