...
VALUES (
    ...
    'seed:configs/prompts/rewrite/selective_rewrite_v2.md:v3',
    TRUE,
    '{"seed": "V37", "reason": "retrieval_anchor_expanded_selective_rewrite"}'::jsonb,
    'file'
)
...
SELECT 'rag_rewrite.ko',
       ...
       '{"seed": "V37", "active_version": "v3"}'::jsonb
FROM active_prompt
