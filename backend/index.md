...
- Prompt catalog migration `V38` registers `selective_rewrite_v2` metadata version `v4` and `selective_rewrite_en_v1` metadata version `v2`, binding `rag_rewrite.ko` / `rag_rewrite.en` to retrieval-context-aware prompt assets.
