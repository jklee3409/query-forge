...
- The backend-served React bundle includes Chat Settings UI polish for concise generation strategy labels, `full gating` preset copy, and compact readiness/status badge spacing without changing API contracts.
