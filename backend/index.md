...
- Synthetic-backed Admin RAG test configs include `raw_only` alongside rewrite/memory modes for same-dataset comparison; `rewrite_threshold` defaults to `0.10`.
