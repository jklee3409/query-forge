...
- Selective rewrite LLM output now carries `preserved_raw_terms`, `added_anchors`, `source_memory_index`, and `intent_risk`; post-processing rejects high-risk or uncovered-anchor candidates before adoption.
